...
static int aie2_mgmt_fw_query(struct amdxdna_dev_hdl *ndev)
{
	 ...
	 * Default aie2_max_col = AIE2_MAX_COL (128); set it explicitly, e.g.:
	...
	XDNA_INFO(ndev->xdna, "total_col=%d (aie2_max_col=%d, fw_metadata.cols=%d, patches=%d)",
		  ndev->total_col, aie2_max_col, ndev->metadata.cols, fw_patches_enable);
